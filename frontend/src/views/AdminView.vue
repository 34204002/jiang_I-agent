...
const agentFile = ref<HTMLInputElement | null>(null)

async function uploadAgentAvatar(e: Event) {
      ...
      <div class="card">
          ...
          <div style="overflow-x:auto">
            <table>
              ...
              <tr v-for="u in users" :key="u.id">
                ...
                <td>
                  <button class="btn-sm" @click="deleteUser(u.id, u.username)">删除</button>
                </td>
              </tr>
              </tbody>
            </table>
        ...
        <div v-if="tab==='agent'">
          ...
          <div class="row">
            ...
            <div class="field"><label>温度 (0-2)</label><input v-model.number="agent.temperature" max="2"
                                                               min="0" step="0.1" type="number"></div>
          </div>
